...
def load_data():
    ...
    repo='https://github.com/StevPav/pret-a-depenser.git',
    mode='rb')
	#pickle_in=open('lgbm_model.pkl', 'rb')
	lgbm=pickle.loads(pickle_in)

	#Chargement des données de test
	db_test=pd.read_csv('https://github.com/StevPav/pret-a-depenser/blob/cdf883e3cfce2bda85c79bb4b739044bffefb126/df_app.csv?raw=true')
	db_test['YEARS_BIRTH']=(db_test['DAYS_BIRTH']/-365).apply(lambda x: int(x))
	db_test=db_test.reset_index(drop=True)
	df_test=pd.read_csv('https://github.com/StevPav/pret-a-depenser/blob/cdf883e3cfce2bda85c79bb4b739044bffefb126/df_test.csv?raw=true')
